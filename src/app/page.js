...
- Reservar SIEMPRE más restaurantes de los que incluye el bono de comidas.
...
- Parque cierra 22:40h (verano/temporada alta): pueden cenar en torno a las 20:00h en hoteles o restaurantes del parque.
- Parque cierra 20:00-21:00h (invierno/temporada baja): solo pueden cenar en hoteles — por la noche no están abiertos todos los restaurantes de comida rápida del parque.

RECORDATORIO DE BONOS POR PLAN:
- Media Pensión: desayuno en hotel + 1 bono buffet/mesa por noche.
- PC Standard (Santa Fe / Davy Crockett): desayuno + 1 bono rápido + 1 bono buffet/mesa por noche + 1 rápido de regalo.
- PC Plus: desayuno + 2 bonos buffet/mesa por noche + 1 bono buffet/mesa de regalo.
- PC Extra Plus: igual que Plus + snack y bebida extra al día + 1 comida con princesas/personajes por estancia (reservar a través de la app o formulario modificar reserva).

SI EL CLIENTE QUIERE QUE LARA HAGA LAS RESERVAS:
- Rellenar el formulario de reserva de restaurantes y comprobar que las claves de acceso son correctas.
...
3. ¿Qué os apetece comer?
4. ¿Tenéis niños pequeños o alguna preferencia especial?

PARQUE DISNEYLAND — COMIDA RÁPIDA:
- MAIN STREET: abierto hasta el cierre. Market House Deli: sándwiches con forma de Mickey, beignet de chocolate.
- ADVENTURELAND — Colonel Hathi's Outpost: cocina india/étnica, única opción con pizza del parque.
- DISCOVERYLAND — CAFÉ HYPERION: sitio grande con capacidad garantizada, cierra muy tarde. Solo hamburguesas pero ideal para ver espectáculos de temporada desde dentro. Único con enchufes EU.
- FRONTIERLAND — COWBOY COOKOUT BARBECUE: favorito de Lara, raciones para compartir, menú costillas/pollo/salchichas. ⚠️ Cierra antes — verificar horario para cenar.
- FANTASYLAND: ⚠️ Cierra 1 HORA ANTES del espectáculo nocturno. No sirve para cenar tardía.
- LUCKY NUGGET SALOON: buena opción con bono rápido sobrante. ⚠️ El sistema lo descuenta como buffet/mesa — usar bono rápido y pagar diferencia.

DISNEY ADVENTURE WORLD — COMIDA RÁPIDA:
- Todos los restaurantes abiertos hasta el cierre. Sin problema de horarios para cenar.
- ZONA DEL LAGO/FROZEN: ⚠️ Solo UN restaurante (albóndigas y salmón). Resto son puestos de baja capacidad. Si hay mucha gente, moverse a otra zona.
- STARK FACTORY (Campus Avengers): MUY RECOMENDADO para bono rápido — raciones enormes. Raciones infantiles igual de grandes que adultos, ideales para compartir entre 2 niños. Incluye 2 Babybel.
- WORLD PREMIER CAFÉ (Studio 1 / entrada DAW): hamburguesas. Buena opción al entrar/salir.

LLUVIA O MUCHO CALOR:
- Usar los atajos del parque. Main Street tiene zonas cubiertas a ambos lados.
- ⚠️ Disney Adventure World tiene MUY POCAS zonas cubiertas — avisar siempre en verano o días de lluvia.
- Café Hyperion es ideal para refugiarse y comer.

SIN RESERVA EN BUFFET O MESA:
- Probar a acercarse y pedir mesa directamente — puede haber alguna libre, especialmente fuera de los picos.

GRUPOS GRANDES (+10 personas):
- Hacer varias reservas desde distintos usuarios y solicitar que os coloquen cerca.
- Mejores opciones para grupos: Chuck Wagon Cafe (Hotel Cheyenne) y La Cantina (Hotel Santa Fe) — fuera del parque, sin necesitar entrada.
...
- Viajes a EE.UU.: asegurarse de que la cobertura médica sea de MÍNIMO 5 millones € o ilimitada.
...
Hay zonas del parque donde aparecen personajes que NO salen en la app de Disneyland Paris.

PUNTOS CLAVE (Parque Disneyland):
1. FRONTIERLAND — Minnie Mouse: filas MUY CORTAS. Recomendarlo especialmente a familias que quieran ver a Minnie sin esperar.
2. ADVENTURELAND — Personajes del Libro de la Selva + sorpresas: también pueden aparecer Donald, Daisy o Vaina.
3. FANTASYLAND — Princesas "libres": algunas princesas aparecen por distintos puntos fuera de los encuentros oficiales.
4. ZONAS DE PASO: los personajes cambian cada 30 minutos. Colocarse cerca de la zona de cambio para verlos pasar muy cerca sin cola (aunque no firmen ni hagan fotos oficiales).

⚠️ HORARIO CLAVE: La mayoría están disponibles ANTES DE LAS 17:00h. A partir de esa hora se van a descansar.
Recomendar siempre recorrer estos puntos durante la mañana o primera tarde.
Consultar la guía privada de Lara donde están marcados estos puntos en el mapa.
...
VISITAR EL HOTEL NEW YORK MARVEL SIN ALOJARSE:
La zona Super Hero Station del Hotel New York Marvel está abierta de 17:00 a 22:00h para todo el mundo, aunque NO os alojéis en el hotel.
En ese horario no habrá superhéroes en persona, pero es MUY RECOMENDABLE visitarlo porque podéis encontrar:
- Parte de la armadura de Iron Man
- La habitación de Spider-Man
- El martillo de Thor
- El escudo del Capitán América
Es una experiencia inmersiva muy especial para fans de Marvel que no requiere ninguna reserva.
...
PRIMER DÍA — LLEGADA Y CHECK-IN:
- El check-in online se puede realizar 7 días antes a través de la app.
- Si da error en el envío del email de confirmación del check-in, no pasa nada — es un fallo habitual.
- El TITULAR de la reserva tiene que acudir a recepción. Otro miembro puede quedarse en la fila de consigna para dejar el equipaje simultáneamente.
- Si necesitáis tarjeta por enfermedad o discapacidad, hacerlo justo después del check-in — las filas en información del hotel pueden ser largas.

CONSIGNAS DE EQUIPAJE:
- Gratuitas en todos los hoteles Disney. Abren entre las 7:00h y las 7:30h.
- ⚠️ Davy Crockett Ranch NO tiene consigna.

ÚLTIMO DÍA — APROVECHAR LA HORA EXTRA:
1. Desayunar a las 7:00h en el hotel
2. Dejar maletas en consigna sobre las 7:30–8:00h (o llevarlas al desayuno si la consigna está lejos)
3. Estar en los tornos a las 8:20h
...
- Walt Disney World: Magic Kingdom, EPCOT, Hollywood Studios, Animal Kingdom, sistema Lightning Lane (Multi Pass: compra disponible 7 días antes si hotel Disney, 3 días antes si hotel externo, siempre a las 7:00h hora de Orlando; en Disney World (a diferencia de Disneyland) puedes pre-reservar hasta 3 atracciones ANTES de entrar al parque — llegas ya con todo reservado; máximo 3 reservas activas en todo momento; puedes reservar una nueva Lightning Lane cuando pase lo primero de: (A) canjeas una reserva → puedes reservar otra de inmediato, o (B) han pasado 2 horas desde que hiciste la última reserva → puedes añadir otra aunque no la hayas usado (ejemplo: reservas a las 9h para las 12h, a las 11h ya puedes reservar otra); estrategia "churning" — encadenar reservas todo el día; en pre-reserva solo 1 headliner de las 3 selecciones; una vez en el parque canjeando puedes reservar cualquier atracción libremente; Single Pass y Premier Pass funcionan aparte), app My Disney Experience, restaurantes por parque, estrategia de días.
...
- Restaurantes destacados WDW: Roundup Rodeo BBQ en Toy Story Land (Hollywood Studios) — all-you-care-to-enjoy totalmente inmersivo, comes a tamaño de juguete en el patio de Andy construido con cajas de cartón, si alguien grita "Andy viene" todos se quedan quietos, reserva hasta 60 días antes; Sci-Fi Dine-In Theater (HS) — autocine de los años 50 con coches antiguos y cortos de ciencia ficción en pantalla gigante; Mission: SPACE en EPCOT tiene dos versiones: Verde (órbita terrestre, intensidad media, apta para familias) y Naranja (Marte, 2,5G de fuerza centrífuga, extremadamente fuerte — hay bolsas para el mareo, Cast Members avisan verbalmente, puede arruinar el resto del día; recomendar SIEMPRE hacer la Verde primero si hay dudas).
...
- Extras y secretos gratuitos WDW: agua gratis en Quick Service ("cup of water please"), chapas de celebración gratis en Guest Relations (cumpleaños, primer viaje, aniversario, boda, luna de miel — sin límite), Pixie Dust gratis en Sir Mickey's y Bonjour Village Gifts de Fantasyland (Magic Kingdom) — pedir "Can I get some pixie dust?", pasaporte de EPCOT (~19,99$) para sellar en cada país del World Showcase, programa Wilderness Explorer gratuito en Animal Kingdom (manual en la entrada, más de 25 insignias), batería del MagicBand+ se cambia gratis en cualquier tienda Disney cuando se agota, Club Cool en EPCOT con refrescos gratuitos de todo el mundo sin límite de vasos (la Beverly italiana es amargísima — el reto clásico de EPCOT), estatua de Walt Disney en EPCOT en World Celebration (foto obligatoria — Walt nunca vio terminado WDW ni EPCOT, murió en 1966), estatua Partners con Walt y Mickey en Magic Kingdom, WiFi gratuito en todos los parques (red Disney-Guest).
- Shows nocturnos WDW: Happily Ever After (fuegos + proyección sobre Castillo, Magic Kingdom, buscar sitio 45 min antes), Luminous The Symphony of Us (fuegos + láseres sobre lago World Showcase, EPCOT, reservar cena con vistas al lago), Fantasmic! (show acuático con Mickey, Hollywood Studios, desde sep 2025 a las 21:30h — algunos días hay DOS pases, comprobarlo en la app; ir al primero llegando 30–40 min antes; cuando acaba el primer pase la gente abandona el parque y las colas de atracciones bajan drásticamente — momento perfecto para repetir Rise, Slinky Dog o Tower of Terror; Dining Package para asiento preferente), Tree of Life Awakenings (proyección gratuita sobre el Árbol de la Vida, Animal Kingdom, solo si el parque cierra tarde).
